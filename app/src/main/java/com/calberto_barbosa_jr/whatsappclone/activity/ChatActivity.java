...
import com.calberto_barbosa_jr.whatsappclone.adapter.MensagensAdapter;
import com.calberto_barbosa_jr.whatsappclone.config.ConfiguracaoFirebase;
import com.calberto_barbosa_jr.whatsappclone.helper.Base64Custom;
...
import com.calberto_barbosa_jr.whatsappclone.model.Grupo;
import com.calberto_barbosa_jr.whatsappclone.model.Mensagem;
                ...
                if ( imagem != null ){
                    ...
                    uploadTask.addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            // Obtendo a referência da imagem no Storage
                            Task<Uri> downloadUrlTask = imagemRef.getDownloadUrl();
                            ...
                            downloadUrlTask.addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        mensagem.setImagem(downloadUrlStr);
                                        ...
                                        Log.d("Erro", "Erro ao obter URL de download");
                                        Toast.makeText(ChatActivity.this,
